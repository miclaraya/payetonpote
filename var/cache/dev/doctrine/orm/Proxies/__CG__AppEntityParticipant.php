...
class Participant extends \App\Entity\Participant implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Participant' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Participant' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Participant' . "\0" . 'email', '' . "\0" . 'App\\Entity\\Participant' . "\0" . 'campaign'];
        }
     ...
     * {@inheritDoc}
     */
    public function setEmail(?string $email): \App\Entity\Participant
    {
     ...
     * {@inheritDoc}
     */
    public function setCampaign(?\App\Entity\Campaign $campaign): \App\Entity\Participant
    {
